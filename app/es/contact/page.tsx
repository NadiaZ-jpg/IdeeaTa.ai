  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-300 py-24 px-4 sm:px-8 flex items-center justify-center">
      <div className="max-w-2xl w-full mx-auto bg-zinc-900/50 border border-zinc-800 rounded-3xl p-8 md:p-12 text-center shadow-2xl relative overflow-hidden">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white mb-6 relative z-10">Contáctanos</h1>
        
        <p className="text-zinc-400 text-lg mb-10 leading-relaxed max-w-lg mx-auto relative z-10 text-justify">
          ¿Tienes alguna pregunta sobre la plataforma, has tenido algún problema técnico o quieres colaborar? ¡Escríbenos y te responderemos lo antes posible!
        </p>

        <div className="bg-[#09090b] border border-zinc-800 rounded-2xl p-6 mb-8 inline-block relative z-10">
          <p className="text-sm text-zinc-500 uppercase tracking-widest font-bold mb-2">Correo de Soporte</p>
        ...
        <div className="mt-8 pt-8 border-t border-zinc-800/50 text-zinc-500 text-sm relative z-10 mb-8">
          <p className="text-justify">El tiempo promedio de respuesta es de 24 a 48 horas, de lunes a viernes.</p>
        </div>

        <div className="flex justify-center relative z-10">
          <Link href="/es/demo?start=nuevo" className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg shadow-emerald-900/30 no-underline">
