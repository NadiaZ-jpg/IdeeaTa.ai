      ...
      <div className="min-h-screen bg-[#09090b] flex flex-col items-center justify-center p-4 font-sans relative overflow-hidden">
        ...
        <div className="w-full max-w-md p-8 md:p-12 bg-zinc-900/80 backdrop-blur-md rounded-3xl border border-zinc-800 shadow-2xl relative z-10 flex flex-col items-center">
          ...
          <div className="relative my-6 w-full flex items-center gap-4">
            ...
            <span className="text-zinc-500 text-xs font-medium">sau</span>
            <div className="flex-1 h-px bg-zinc-800"></div>
          </div>
          ...
          <button
            ...
            className="w-full mt-4 py-3 px-5 flex items-center justify-center gap-3 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-xl transition-all shadow-md text-sm border border-zinc-700"
          >
