...
type UIStringsShape = {
  ...
  paywallBtn: string; studioHeaderSubtitle: string; costDistribution: string; protectedContentPrint: string;
...
export const UI_STRINGS: Record<Locale, UIStringsShape> = {
  ro: {
    ...
    limitReached: "Ai epuizat cele 3 planuri gratuite fără cont. Înregistrează-te gratuit pentru a debloca încă +1 plan.",
    limitRemaining: "Mai ai dreptul la {{count}} planuri gratuite fără cont. Creează cont gratuit ulterior pentru încă +1 plan.",
    ...
    studioGenerateDesktopOnly: "Pe telefon și tabletă poți edita un plan deja salvat. Generarea unui plan nou în Studio se face pe desktop.",
    studioGenerateDesktopHint: "Deschide Dashboard pe un ecran mai mare pentru a crea un plan, sau încearcă Demo pe mobil.",
    ...
    paywallBtn: "Vizitează IdeeaTa.ai", studioHeaderSubtitle: "Proiectul tău de afaceri inteligent", costDistribution: "Distribuția Costurilor", protectedContentPrint: "Conținutul este protejat. Pentru a obține documentul, utilizați funcția de descărcare din aplicație.",
  ...
  en: {
    ...
    paywallBtn: "Visit IdeeaTa.ai", studioHeaderSubtitle: "Your intelligent business project", costDistribution: "Cost Distribution", protectedContentPrint: "Content is protected. To get the document, use the download function in the app.",
  ...
  es: {
    ...
    shareBtn: "Compartir", shareCopied: "Enlace copiado al portapapeles!", shareError: "No se pudo crear el enlace para compartir. Intentalo de nuevo.", shareLinkTitle: "Copiar enlace",
    ...
    paywallBtn: "Visita IdeeaTa.ai", studioHeaderSubtitle: "Tu proyecto de negocio inteligente", costDistribution: "Distribución de Costes", protectedContentPrint: "El contenido está protegido. Para obtener el documento, utilice la función de descarga en la aplicación.",
