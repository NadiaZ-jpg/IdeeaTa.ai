...
export default function Home() {
  ...
  const isPlanPaid = promoCodeUnlocked || isAdmin;
  const isStudioPaid = promoCodeUnlocked || isAdmin;
  ...
  const randomIdeas = [
    ...
    "Fermă de cultivare a algelor pentru suplimente alimentare și cosmetice",
    "Servicii de imprimare 3D pentru piese de schimb personalizate",
    "Platformă online de închiriere a echipamentelor medicale la domiciliu",
    "Atelier de upcycling pentru mobilier vechi",
    "Abonament pentru kit-uri de știință și robotică pentru copii",
    "Clinică de recuperare sportivă cu echipamente de crioterapie",
    "Aplicație de gestionare a bugetului familial cu inteligență artificială",
    "Magazin online cu produse cosmetice 100% vegane și cruelty-free",
    "Serviciu de asistență virtuală specializat pe medici și clinici",
    "Organizator de evenimente eSports la nivel local și regional",
    "Pensiune agroturistică cu ateliere de olărit și brutărie artizanală",
    "Agenție de SEO vocal și optimizare pentru asistenți inteligenți",
    "Platformă pentru rezervarea de spații de co-working în cafenele",
    "Servicii de îngrijire a plantelor de interior pentru corporații",
    "Centru de dezvoltare personală și mindfulness pentru adolescenți",
    "Aplicație care traduce meniul restaurantelor în funcție de alergiile utilizatorului",
    "Producție de cărămizi ecologice din materiale reciclate",
    "Serviciu de închiriere de scutere electrice pentru livratori independenți",
    "Platformă pentru evaluarea și certificarea amprentei de carbon a IMM-urilor",
    "Gogoșerie artizanală cu arome internaționale și opțiuni fără gluten",
    "Studio de producție podcast-uri cu echipamente de închiriere la oră",
    "Aplicație mobilă de gamificare a productivității pentru echipe remote",
    "Serviciu de consultanță în securitate cibernetică pentru afaceri mici",
    "Magazin de unelte și echipamente recondiționate pentru grădinărit",
    "Platformă de micro-investiții în imobiliare comerciale",
    "Fermă ecologică specializată în cultivarea ciupercilor exotice",
    "Agenție de creare de conținut video vertical pentru branduri",
    "Platformă pentru rezervarea de bucătari privați pentru evenimente acasă",
    "Abonament de carte fizică cu recenzii și note din partea autorilor",
    "Serviciu mobil de schimb de anvelope și vulcanizare",
    "Aplicație pentru monitorizarea și optimizarea consumului de energie în casă",
    "Academie de coding și robotică pentru vârstnici",
    "Magazin online de produse artizanale făcute exclusiv de mame antreprenor",
    "Servicii de creare a tururilor virtuale 360° pentru agenții imobiliare",
    "Platformă de schimb de jucării și haine pentru copii",
    "Agenție de PR specializată exclusiv în startup-uri tech",
    "Pizzerie artizanală cu maia și ingrediente 100% locale",
    "Aplicație de meditație și yoga cu instructori live",
    "Serviciu de organizare și decluttering pentru case și birouri",
    "Platformă de recenzii video scurte pentru produse electronice",
    "Brand de haine streetwear cu design generat de inteligență artificială",
    "Clinică mobilă pentru testarea vederii și prescrierea de ochelari",
    "Serviciu de livrare de sucuri presate la rece pe bază de abonament",
    "Fermă de trufe cu programe de turism de vânătoare a trufelor",
    "Aplicație de închiriere de echipament foto/video între pasionați",
    "Platformă pentru vânzarea și achiziționarea de afaceri mici, la cheie",
    "Serviciu de audit al accesibilității digitale pentru site-uri web",
    "Barber shop modern integrat cu bar și biliard",
    "Abonament la kit-uri de bricolaj (DIY) pentru decorațiuni interioare",
    "Servicii de instalare și mentenanță pentru panouri solare rezidențiale",
    "Aplicație de navigare optimizată pentru utilizatorii de scaune cu rotile",
    "Brand de produse de curățenie la vrac cu stații de reumplere în supermarket",
    "Agenție de ghostwriting pentru conturi de LinkedIn ale antreprenorilor",
    "Producție de biciclete electrice personalizate din lemn sau bambus",
    "Serviciu de consultanță privind drepturile consumatorilor",
    "Platformă pentru rezervarea de parcări private în orașele aglomerate",
    "Studio de arhitectură specializat în case pasive și Tiny Houses",
    "Aplicație de dating bazată exclusiv pe compatibilitate muzicală",
    "Magazin fizic cu cabine de probă virtuală (Oglinzi AR)",
    "Fermă ecologică de fructe de pădure cu funcție pick-your-own"
  ];
        ...
        <div className="w-full max-w-6xl flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-10">
          ...
          {!isEditing && (
            ...
            <div id="section-financial" className="pt-10 border-t border-zinc-800 print:border-none print:pt-4">
               ...
               <div className="fixed left-[-9999px] top-0 pointer-events-none z-[-1] w-[1000px] h-[450px] bg-white flex flex-col items-center justify-center" id="docx-export-chart">
