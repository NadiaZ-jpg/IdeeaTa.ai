...
// Anti-Crash protection: AI sometimes hallucinates objects instead of strings
      ...
      <div className="flex flex-col gap-8 items-stretch w-full">
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              type="text" value={safeString(result.nume || '')}
          ...
          <div className="flex flex-col gap-2">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={2} value={safeString(result.viziune_strategie?.obiective_scurt || '')} onChange={readOnly ? noop : (e) => updateField(['viziune_strategie', 'obiective_scurt'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={2} value={safeString(result.viziune_strategie?.obiective_mediu || '')} onChange={readOnly ? noop : (e) => updateField(['viziune_strategie', 'obiective_mediu'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={3} value={safeString(result.viziune_strategie?.misiune_valori || '')} onChange={readOnly ? noop : (e) => updateField(['viziune_strategie', 'misiune_valori'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 w-full pt-6 border-t border-zinc-800">
          ...
          <div className="flex flex-col gap-2">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={3} value={safeString(result.analiza_pietei?.clienti_tinta || '')} onChange={readOnly ? noop : (e) => updateField(['analiza_pietei', 'clienti_tinta'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={3} value={safeString(result.analiza_pietei?.concurenta || '')} onChange={readOnly ? noop : (e) => updateField(['analiza_pietei', 'concurenta'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={3} value={safeString(result.analiza_pietei?.strategie_marketing || '')} onChange={readOnly ? noop : (e) => updateField(['analiza_pietei', 'strategie_marketing'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 w-full pt-6 border-t border-zinc-800">
          ...
          <div className="flex flex-col gap-2">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={4} value={safeString(result.plan_operational?.descriere_flux || '')} onChange={readOnly ? noop : (e) => updateField(['plan_operational', 'descriere_flux'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={3} value={safeString(result.plan_operational?.resurse_umane || '')} onChange={readOnly ? noop : (e) => updateField(['plan_operational', 'resurse_umane'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={3} value={safeString(result.plan_operational?.locatie_dotari || '')} onChange={readOnly ? noop : (e) => updateField(['plan_operational', 'locatie_dotari'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
        </div>
        ...
        <div id="section-financial" className="flex flex-col gap-6 w-full pt-6 border-t border-zinc-800">
          ...
          <div className="flex flex-col gap-2 mb-6">
            ...
            <AutoExpandingTextarea readOnly={readOnly} rows={4} value={safeString(result.plan_financiar?.strategie_financiara || '')} onChange={readOnly ? noop : (e) => updateField(['plan_financiar', 'strategie_financiara'], e.target.value)} className="bg-zinc-900 border border-zinc-700 p-4 rounded-xl text-lg w-full leading-relaxed" />
          </div>
