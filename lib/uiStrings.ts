...
export const UI_STRINGS: Record<Locale, UIStringsShape> = {
  ...
  es: {
    ...
    limitReached: "Has agotado las 3 generaciones gratuitas como invitado. Regístrate gratis para desbloquear +1 plan más.",
    limitRemaining: "Te quedan {{count}} generaciones de planes gratuitos como invitado. Crea una cuenta gratuita más tarde para +1 más.",
