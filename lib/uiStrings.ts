...
export const UI_STRINGS: Record<Locale, UIStringsShape> = {
  ...
  es: {
    ...
    studioGenerateDesktopOnly: "Describe tu idea y genera el plan directamente en el telefono o tablet.",
    studioGenerateDesktopHint: "El asistente crea el plan completo; luego puedes editarlo y exportarlo aqui.",
