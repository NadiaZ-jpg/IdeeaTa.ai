...
type UIStringsShape = {
  ...
  // NEW ADDITIONS
  planGeneratedSmartly: string; filePresentation: string; fileSummaryFree: string; fileDocument: string;
  howItLooks: string; perspective: string; previewTabs: string; animatedCharts: string; typingLive: string;
  beforeAfter: string; generatedExample: string; coffeeShopName: string; paywallTitle: string; paywallDesc: string;
  paywallBtn: string; studioHeaderSubtitle: string; costDistribution: string;
};
...
export const UI_STRINGS: Record<Locale, UIStringsShape> = {
  ro: {
    ...
    planGeneratedSmartly: "Plan generat inteligent de IdeeaTa.ai", filePresentation: "Prezentare", fileSummaryFree: "Sumar_Gratuit", fileDocument: "Document",
    ...
    beforeAfter: "Înainte & După", generatedExample: "EXEMPLU GENERAT", coffeeShopName: "Cafenea de Specialitate 'Urban Beans'", paywallTitle: "Acesta a fost doar un scurt rezumat.", paywallDesc: "Pentru a obține Analiza SWOT detaliată, Bugetul de investiții, Strategia de Piață completă și Planul Operațional, creează-ți un cont gratuit!",
  ...
  en: {
    ...
    planGeneratedSmartly: "Business plan smartly generated by IdeeaTa.ai", filePresentation: "Presentation", fileSummaryFree: "Free_Summary", fileDocument: "Document",
    ...
    beforeAfter: "Before & After", generatedExample: "GENERATED EXAMPLE", coffeeShopName: "Specialty Coffee Shop 'Urban Beans'", paywallTitle: "This was just a short summary.", paywallDesc: "To get the detailed SWOT Analysis, Investment Budget, Full Market Strategy, and Operational Plan, create a free account!",
  ...
  es: {
    ...
    planGeneratedSmartly: "Plan de negocios generado inteligentemente por IdeeaTa.ai", filePresentation: "Presentacion", fileSummaryFree: "Resumen_Gratuito", fileDocument: "Documento",
    ...
    beforeAfter: "Antes y Después", generatedExample: "EJEMPLO GENERADO", coffeeShopName: "Cafetería de Especialidad 'Urban Beans'", paywallTitle: "Este fue solo un breve resumen.", paywallDesc: "¡Para obtener el Análisis FODA detallado, el Presupuesto de Inversión, la Estrategia de Mercado y el Plan Operativo, crea una cuenta gratuita!",
